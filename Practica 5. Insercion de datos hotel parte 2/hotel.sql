...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:20:01
...
(1, 5, 6, '2026-02-06', 'hotel buen estado y excelente servicio'),
(2, 2, 4, '2026-02-03', 'buen hotel pero comida mala'),
(3, 7, 7, '2026-01-15', 'falta un mejor servicio\r\n'),
(4, 8, 6, '2026-01-21', 'hotel bien decorado y buena atención'),
(5, 5, 4, '2026-01-26', 'buena piscina y comida');
...
(1, 7, '2026-02-04', 500, 'efectivo', 'ivan moreno', 'pagado'),
(2, 1, '2026-02-14', 400, 'transferencias', 'luis obeso', 'pagado'),
(3, 6, '2026-01-17', 1500, 'efectivo', 'kenneth', 'pago rechazado'),
(4, 2, '2026-01-28', 2000, 'efectivo', 'axel lopez', 'pagado'),
(5, 4, '2026-02-08', 2500, 'transferencia', 'jose alvarado', 'pagado');
...
(1, 'servicio de limpieza', 200),
(2, 'servicio de bar', 600),
(3, 'servicio de spa', 250),
(4, 'servicio de lavanderia', 50),
(5, 'servicio de comida', 150);
